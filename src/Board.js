...
export class MacroTacticsBoard extends React.Component {
  ...
  constructor(props) {
    super(props)
    this.state = { player0DeckToggled: false,player1DeckToggled: false, cardDescToggle: false, cardDesc: '',inviteLink: `vigilant-mccarthy-53bcb3.netlify.app/play/${this.props.matchID}/` + (this.props.playerID === "0" ? 'second' : 'first'),
  ...
  componentDidMount() {
    ...
    if (qs.inviteLink === '1') {
        this.setState({ inviteLinkShow: true, inviteLink: `vigilant-mccarthy-53bcb3.netlify.app/play/${this.props.matchID}/` + (this.props.playerID === "0" ? 'second' : 'first') })
